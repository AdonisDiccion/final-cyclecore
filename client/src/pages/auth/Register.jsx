            ...
            >
              ...
              <DialogContent>
                <div className="space-y-5 mb-5">
                  <strong className="font-bebas">Welcome to Cyclecore!</strong>
            ...
            <Dialog open={openDialog2} onClose={() => setOpenDialog2(false)}>
              ...
              <DialogContent>
                ...
                <div className="font-oswald space-y-5">
                  ...
                  <h1 className="font-bold font-bebas">Information we collect</h1>
                  <p>
                  ...
                  <h1 className="font-bold font-bebas">How we use your information</h1>
                  <p>
                  ...
                  <h1 className="font-bold font-bebas">Cookies and Web Beacons</h1>
                  <p>
                  ...
                  <h1 className="font-bold font-bebas">Changes to This Privacy Policy</h1>
                  <p>
