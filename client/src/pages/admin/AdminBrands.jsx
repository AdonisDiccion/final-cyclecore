            ...
            <tbody className="tracking-wide">
              {brands?.map((brand) => (
                <tr key={brand._id} className="border-b border-gray-300">
                  <td className="text-left py-3 px-4 font-oswald text-sm">{brand._id}</td>
                  <td className="text-left py-3 px-4 ">
                    <div className="flex items-center  space-x-2 ">
                      <div className="flex-1">
                        <span className="mr-4 font-oswald text-sm">{brand.name}</span>
                      </div>
                      <div className="flex">
                        <Button
                          onClick={() => {
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <form>
                  <div>
                    <div className="flex">
                      <div className="relative p-6 flex-auto">
                        <InputLabel><span className="font-bebas text-sm tracking-wide">Update Brand</span></InputLabel>
                        <TextField
                          value={updatingName}
                          onChange={(e) => {
