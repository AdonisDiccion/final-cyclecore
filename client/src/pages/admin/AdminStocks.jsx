              ...
              <tbody>
                {products?.map((p) => (
                  <tr key={p._id} className="border-b">
                    <td className="text-left py-3 px-4 font-oswald text-sm">{p._id}</td>

                    <td className="text-left py-3 px-4 font-oswald text-sm">{p.name}</td>

                    <td className="text-left py-3 px-4 font-oswald text-sm">{p.stocks}</td>
