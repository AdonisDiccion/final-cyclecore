                      ...
                      {o?.products?.map((p, i) => (
                        <>
                          <tr key={i} className="border-b">
                            <td className="p-2 font-oswald text-sm">{o?.ordernumber}</td>

                            <td className="p-2 font-oswald text-sm">
                              {o?.buyer?.lastname},{o?.buyer?.firstname}
                            </td>

                            <td className="p-2 font-oswald text-sm">{p.name}</td>
                            ...
                            <td className="p-2 font-oswald text-sm">{o?.buyer?.email}</td>
