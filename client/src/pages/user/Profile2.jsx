                ...
                <div key={i} className="mt-5">
                  <div className="p-3 border border-[#00ac6a] bg-[#e9f9ee] rounded-sm">
                    ...
                    <div className="text-sm tracking-wide">
                      Street:
                      <span className="font-bold font-oswald text-xs ml-1">
                        {a.street}
                      </span>
                    </div>
                    <div className="text-sm tracking-wide">
                    ...
                    <div className="text-sm tracking-wide">
                      Municipality:
                      <span className="font-bold font-oswald text-xs ml-1">{a.city}</span>
                    </div>
                    <div className="text-sm tracking-wide">
                      Postal Code:
                      <span className="font-bold font-oswald text-xs ml-1">
                    ...
                    <div className="text-sm tracking-wide">
                      ...
                      <span className="font-medium font-kanit text-sm">
                        {a.street},{a.barangay},{a.city} {a.region}, {a.postalCode}
                      </span>
                    </div>
