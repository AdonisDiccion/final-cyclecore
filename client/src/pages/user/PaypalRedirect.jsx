          ...
          <>
            <div className="max-w-2xl mx-auto">
              ...
              <div className=" bg-white p-2">
                <h1 className="flex items-center gap-1 tracking-wider font-bold text-xl justify-center">Redirecting to cyclecore bikeshop <TbFidgetSpinner fontSize={30} className="animate-spin" /></h1>           
              </div>
            </div>
          </>
        ) : (
          <>
            <div className="max-w-2xl mx-auto">
              ...
              <div className="bg-red-500 text-center font-bebas text-white space-y-4 p-3">
                ...
                <button className="font-bold text-xl tracking-wider p-2 bg-white w-full" onClick={() => navigate("/dashboard/user/checkout")}>Go Back</button>
