            ...
            <Paper className="p-3 space-y-4">
              ...
              <div className="px-10 space-y-3 text-sm">
                {selectedFrame && (
                  <div className="flex justify-between">
                    Selected frame:{" "}
                    <span className="font-medium font-oswald text-xs">{selectedFrame.name}</span>
                    <span>
                ...
                {selectedHandleBar && (
                  <div className="flex justify-between">
                    Selected Handlebar:{" "}
                    <span className="font-medium font-oswald text-xs">{selectedHandleBar.name}</span>{" "}
                    <span>
                ...
                {selectedGroupSet && (
                  <div className="flex justify-between">
                    Selected groupset:{" "}
                    <span className="font-medium font-oswald text-xs">{selectedGroupSet.name}</span>{" "}
                    <span>
                ...
                {selectedWheelSet && (
                  <div className="flex justify-between">
                    Selected wheelset:{" "}
                    <span className="font-medium font-oswald text-xs">{selectedWheelSet.name}</span>
                    <span>
                ...
                {selectedTire && (
                  <div className="flex justify-between">
                    Selected tire:{" "}
                    <span className="font-medium font-oswald text-xs">{selectedTire.name}</span>
                    <span>
                ...
                {selectedSaddle && (
                  <div className="flex justify-between">
                    Selected saddle:{" "}
                    <span className="font-medium font-oswald text-xs">{selectedSaddle.name}</span>
                    <span>
