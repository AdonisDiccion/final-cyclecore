...
import { CancelForm } from "../../components/section/CancelForm";
...
export default function UserOrders() {
  ...
  const [refundRequest, setRefundRequest] = useState('`Refund Request for Order ID ${o.ordernumber}: I request a refund for order ${o.ordernumber} due to dissatisfaction. Please process the refund promptly. Thank you.`');
          ...
          <div className="flex items-center py-3">
            <div className="flex gap-32 flex-1">
                <div className="tracking-wide text-sm">
                  {" "}
                  Order ID :{" "}
                  <span className="font-semibold font-oswald text-sm">{o.ordernumber}</span>
                </div>
                ...
                <div className="text-sm">
                  Status: <span className="text-sm font-bold font-oswald">{o.status}</span>
                </div>
            </div>
            

            <div>
              <button className="p-2 border border-red-500 rounded-md" onClick={() => setOpenCancel(true)}>Cancel / Refund</button>
            </div>
          </div>
                ...
                {o?.products?.map((p, i) => (
                  <div className="flex justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-sm">
                          Name: <span className="text-sm font-oswald">{p.name}</span>
                        </div>
                        <div className="text-sm">
                          Qty: <span className="text-sm font-oswald">{p.quantity}</span>
                        </div>
                        <div className="text-sm">
              ...
              <div className="flex justify-between ">
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <h2 className="font-oswald">
                    <span className="font-bebas text-sm">Your Order Number:</span> <span className="text-sm font-medium">{o.ordernumber}</span>
                  </h2>
                </div>
