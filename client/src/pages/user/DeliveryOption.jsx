                    ...
                    {selectedOption === 2 && (
                      <>
                        <div className="bg-gray-50 p-2 rounded-md">
                            <img src={paypal} alt="" className="w-[25rem] mx-auto"/>

                            <div>
                              <button className="w-full rounded-full bg-[#fec33a] hover:bg-[#ffd164]" onClick={handlePaypalClick}>
                                <img src={paypal} alt="" className="w-24 mx-auto"/>
                              </button>
                            </div>
                        </div>                      
                      </>
                    ...
                    {selectedOption === 1 ? (
                      ...
                      <div className="flex justify-end">
                        <button
                          ...
                          className={`${selectedOption === 2 && "hidden"} flex items-center gap-1 bg-yellow-300 p-3 rounded-md tracking-wide hover:scale-105 duration-200 ease-in-out`}
                        >
                          <MdPayment />
                          Check - Out
                        </button>
